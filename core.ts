...
import { TEMPLATE_DOCS_ID, YEAR_CODE } from "./general.ts";
...
function onSubmit(event: GoogleAppsScript.Events.FormsOnFormSubmit) {
  ...
  printDocObject = construction.setupPrintDocs(printDocObject, construction.buildDocName(templateIDDict, '[INVOICE] - ', ["Formal Company Name"], `_UP CAPES ${YEAR_CODE}`));
